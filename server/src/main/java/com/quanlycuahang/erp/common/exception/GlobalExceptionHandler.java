...
public class GlobalExceptionHandler {
  ...
  public ResponseEntity<ApiResponse<Void>> handleValidation(MethodArgumentNotValidException ex) {
    ...
    ApiError error = new ApiError("VALIDATION_ERROR", "Du lieu khong hop le", fieldErrors);
  ...
  public ResponseEntity<ApiResponse<Void>> handleOptimisticLock(
    ...
    ApiError error =
        new ApiError(
            ...
            "San pham vua het hang hoac dang duoc cap nhat, vui long thu lai",
            Map.of());
  ...
  public ResponseEntity<ApiResponse<Void>> handleDataIntegrityViolation(
    ...
    ApiError error = new ApiError("CONFLICT", "Du lieu bi trung hoac vi pham rang buoc", Map.of());
    return ResponseEntity.status(HttpStatus.CONFLICT).body(ApiResponse.error(error));
  }
  ...
  public ResponseEntity<ApiResponse<Void>> handleUnexpected(Exception ex) {
    ...
    ApiError error =
        new ApiError("INTERNAL_ERROR", "Da xay ra loi he thong, vui long thu lai sau", Map.of());
