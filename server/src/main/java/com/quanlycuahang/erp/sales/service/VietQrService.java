...
public class VietQrService {
  ...
  public String generatePayload(BigDecimal amount, String purpose) {
    ...
    String beneficiaryInfo = tlv("00", defaultBankBin) + tlv("01", defaultAccountNumber);
    ...
    payload.append(tlv("59", truncate(defaultMerchantName, 25)));
    payload.append(tlv("60", truncate(defaultMerchantCity, 15)));
