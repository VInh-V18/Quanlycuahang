...
public final class InvoiceDetailAssembler {
  ...
  public static InvoiceDetailResponse assemble(
    ...
    response.setTotalQuantity(
        items.stream().map(OrderItem::getQuantity).reduce(BigDecimal.ZERO, BigDecimal::add));
