...
- **Error**: lỗi nghiệp vụ (hết hàng, voucher không hợp lệ, lệch giá) hiện
  `Toast` đỏ ở góc trên phải màn hình (Topbar chung), không chặn thao tác
  tiếp theo, không làm mất dữ liệu giỏ hàng đã nhập.
- Mất kết nối mạng khi đang thao tác giỏ hàng → giỏ hàng vẫn giữ nguyên
  ...
  nối, một số thao tác có thể chậm" ở đầu vùng nội dung POS.
