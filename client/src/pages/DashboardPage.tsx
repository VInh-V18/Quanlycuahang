 ...
 * su dung cong thuc doanh thu/lai gop/top san pham voi module Bao cao (Phase 10). */
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
        <Card>
          <CardHeader>
            ...
            <CardDescription>Sản phẩm dưới định mức tối thiểu tại chi nhánh hiện tại</CardDescription>
          </CardHeader>
          <CardContent>
            <DataTable
